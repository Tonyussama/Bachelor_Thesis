...
# url = 'rtsp://admin:ahmed_sleem_22@192.168.1.109/cam/realmonitor?channel=1&subtype=00&authbasic=YWRtaW46YWRtaW4='
# url2 = 'rtsp://admin:Tony0000@192.168.1.108/cam/realmonitor?channel=1&subtype=00&authbasic=YWRtaW46YWRtaW4='
# cap_right = cv2.VideoCapture(url, cv2.CAP_DSHOW)
# cap_left = cv2.VideoCapture(url2, cv2.CAP_DSHOW)
...
alpha = 101  # Camera field of view in the horisontal plane [degrees]
